...
Lx1=1385;%2888.9388;%2624.2800;%3157;%标定架底盘x轴+方向实际走的长度
Lx2=1345;%2887.5160;%2624.2800;%3157;%标定架底盘x轴-方向实际走的长度
...
coderA2 = 11180;%4663.934;   %4206.7275;%(14026+14020+14021)/3;%y-方向数据
coderA3 =-12443;%-4745.9031;  %-4210.5853;%(-13997-14010-14009)/3;%x+方向数据
coderA4 = 12288;%4744.0638;%4156.7145;%(13982+13980+13971)/3;%x-方向数据

coderB1= 11264;% 4661.7981;%4200.3444;%(14035+14037+14037)/3;%y+方向数据
coderB2=-11531;%-4666.3794;%-4227.2943;%(-14005-14011-14009)/3;%y-方向数据
coderB3=-12235;%-4585.6036;%-4197.8226;%(-14010-14003-14008)/3;%x+方向数据
coderB4= 11986;%4580.2316;%4202.6313;%(14016+14018+14009)/3;%x-方向数据
